...
namespace haxe.iterators {
	public class StringKeyValueIterator : global::haxe.lang.HxObject {
		...
		public object next() {
			int tmp = this.offset;
			{
				int __temp_odecl1 = global::StringTools.fastCodeAt(this.s, this.offset++);
				return new global::haxe.lang.DynamicObject(new int[]{}, new object[]{}, new int[]{5343647, 834174833}, new double[]{((double) (tmp) ), ((double) (__temp_odecl1) )});
			}
