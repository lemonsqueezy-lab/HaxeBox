...
@:native("Sandbox.SceneObject")
extern class SceneObject {
    overload function new(sceneWorld:sandbox.SceneWorld, modelName:String):Void;
    overload function new(sceneWorld:sandbox.SceneWorld, modelName:String, transform:Transform):Void;
    overload function new(sceneWorld:sandbox.SceneWorld, model:sandbox.Model):Void;
    ...
    function AddChild(name:String, child:sandbox.SceneObject):Void;
    /** Clear all material replacements. */
    function ClearMaterialOverride():Void;
    ...
    function RemoveChild(child:sandbox.SceneObject):Void;
    ...
    overload function SetMaterialOverride(material:sandbox.Material):Void;
    overload function SetMaterialOverride(material:sandbox.Material, attributeName:String, attributeValue:Int):Void;
}
