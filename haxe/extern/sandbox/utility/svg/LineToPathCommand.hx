...
/** See . */
@:native("Sandbox.Utility.Svg.LineToPathCommand")
extern class LineToPathCommand extends sandbox.utility.svg.PathCommand {
    /** See . */
    overload function new(X:Single, Y:Single):Void;
    @:protected overload function new(original:sandbox.utility.svg.LineToPathCommand):Void;
    var X(default,default):Single;
    var Y(default,default):Single;
    function Deconstruct(X:Single, Y:Single):Void;
    overload function Equals(obj:cs.system.Object):Bool;
    overload function Equals(other:sandbox.utility.svg.LineToPathCommand):Bool;
