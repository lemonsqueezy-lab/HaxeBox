...
@:native("Sandbox.Services.PackageInteraction")
final extern class PackageInteraction {
    ...
    var AchievementScore(default,set):Int;

    private inline function set_AchievementScore(value:Int):Int {
        var __value:Int = cast value;
        return untyped __cs__("{0}.AchievementScore = {1}", this, __value);
    }

    var AchievementCount(default,set):Int;

    private inline function set_AchievementCount(value:Int):Int {
        var __value:Int = cast value;
        return untyped __cs__("{0}.AchievementCount = {1}", this, __value);
    }
