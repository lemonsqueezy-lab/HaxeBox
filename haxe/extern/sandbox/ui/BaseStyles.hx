...
extern class BaseStyles {
    ...
    function ApplyCascading(parent:sandbox.ui.BaseStyles):Void;
    /** Perform a deep copy of this stylesheet */
    function Clone():cs.system.Object;
    ...
    @:protected overload function Lerp(o:Null<Color>, a:Null<Color>, b:Null<Color>, defaultValue:Null<Color>, delta:Single):Void;
    @:protected overload function Lerp(o:Null<Int>, a:Null<Int>, b:Null<Int>, defaultValue:Null<Int>, delta:Single):Void;
    @:protected overload function Lerp(o:Null<Single>, a:Null<Single>, b:Null<Single>, defaultValue:Null<Single>, delta:Single):Void;
    @:protected overload function Lerp(o:Null<sandbox.ui.Length>, a:Null<sandbox.ui.Length>, b:Null<sandbox.ui.Length>, defaultValue:Null<sandbox.ui.Length>, delta:Single):Void;
    @:protected overload function Lerp(o:Null<sandbox.ui.PanelTransform>, a:Null<sandbox.ui.PanelTransform>, b:Null<sandbox.ui.PanelTransform>, defaultValue:Null<sandbox.ui.PanelTransform>, delta:Single):Void;
    ...
    function SetRect(r:sandbox.Rect, scale:Single):Void;
}
