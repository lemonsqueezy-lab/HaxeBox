...
public sealed class Array<T> : global::haxe.lang.HxObject, global::Array {
	...
	public global::Array<T> concat(global::Array<T> a) {
		...
		return global::Array<object>.ofNative<T>(((T[]) (retarr) ));
	}
		...
		unchecked {
			...
			while ((  ++ i < length )) {
				if (first) {
					...
					buf.@add<string>(((string) (sep) ));
				}
				
				buf.@add<T>(global::haxe.lang.Runtime.genericCast<T>(this.__a[i]));
			}
	...
	public global::Array<T> slice(int pos, global::haxe.lang.Null<int> end) {
		...
		return global::Array<object>.ofNative<T>(((T[]) (newarr) ));
	}
	...
	public global::Array<T> splice(int pos, int len) {
		...
		global::Array<T> ret1 = global::Array<object>.ofNative<T>(((T[]) (ret) ));
		int end = ( pos + len );
	...
	public string __hx_toString() {
		...
		bool first = true;
		{
			...
			while (( _g < _g1 )) {
				...
				ret.@add<T>(global::haxe.lang.Runtime.genericCast<T>(a[i]));
			}
	...
	public global::Array<S> map<S>(global::haxe.lang.Function f) {
		global::Array<S> ret = global::Array<object>.alloc<S>(((int) (this.length) ));
		{
			int _g = 0;
			int _g1 = this.length;
			while (( _g < _g1 )) {
				int i = _g++;
				ret.__unsafe_set(i, global::haxe.lang.Runtime.genericCast<S>(f.__hx_invoke1_o(default(double), this.__unsafe_get(i))));
			}
