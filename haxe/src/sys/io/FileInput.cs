...
namespace sys.io {
	public class FileInput : global::cs.io.NativeInput {
		...
		public FileInput(global::System.IO.Stream stream) : base(((global::haxe.lang.EmptyObject) (global::haxe.lang.EmptyObject.EMPTY) )) {
			global::sys.io.FileInput.__hx_ctor_sys_io_FileInput(this, stream);
		}
		
		
		protected static void __hx_ctor_sys_io_FileInput(global::sys.io.FileInput __hx_this, global::System.IO.Stream stream) {
